...
assert(pages.every((html) => html.includes("/assets/maensat-enhancements.css?v=20260825-sports-v11")), "Enhancement stylesheet missing from a page");
assert(pages.every((html) => html.includes("/assets/football-matches.js?v=20260825-matches-v6") && html.includes('id="sports"') && html.includes('id="sportsMatchesPanel"')), "Football schedule assets missing from a page");
...
assert(matchesScript.includes("var MATCHES_URL") && matchesScript.includes("/data/football-matches.json") && matchesScript.includes("function loadMatches") && matchesScript.includes("function renderMatchCard") && matchesScript.includes("sports-competition-heading") && matchesScript.includes("sports-competition-card") && matchesScript.includes("data-competition-window") && matchesScript.includes("data-competition-toggle") && matchesScript.includes("aria-expanded") && matchesScript.includes('matchesWindow: "week"'), "Football matches loader, collapsible league cards, or week default is missing");
