...
assert(pages.every((html) => html.includes("/assets/football-matches.js?v=20260825-matches-v2") && html.includes('id="sports"') && html.includes('id="sportsMatchesPanel"')), "Football schedule assets missing from a page");
...
assert(matchesScript.includes("var MATCHES_URL") && matchesScript.includes("/data/football-matches.json") && matchesScript.includes("function loadMatches") && matchesScript.includes("function renderMatchCard") && matchesScript.includes("sports-competition-heading"), "Football matches loader or competition grouping is missing");
